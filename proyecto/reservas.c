...
int main(int argc, char *argv[])
{
    ...
    {
#ifdef __PRINT_PROCESO
        printf("RESERVAS --> no tengo que pedir el testigo.\n");
#endif
        sem_post(&(me->sem_tengo_que_pedir_testigo));
        sem_post(&(me->sem_prioridad_maxima));
...
#ifdef __PRINT_PROCESO
            printf("RESERVAS --> tengo que esperar porque no tengo permiso.\n");
#endif
...
#ifdef __PRINT_PROCESO
        printf("RESERVAS --> La prioridad maxima está en otro nodo, tengo que enviar el testigo.\n");
#endif
    ...
    else
    {
        ...
        { // Prioridad maxima en mi nodo
#ifdef __PRINT_PROCESO
            printf("RESERVAS --> la prioridad maxima está en mi nodo.\n");
#endif
            sem_post(&(me->sem_prioridad_maxima));
            ...
            else
            {
                ...
                {
#ifdef __PRINT_PROCESO
                    printf("RESERVAS --> le doy paso a admin_res.\n");
#endif
                    sem_post(&(me->sem_prioridad_maxima));
...
#ifdef __PRINT_PROCESO
            printf("RESERVAS --> Mi nodo y otro nodo tenemos la misma prioridad.\n");
#endif
            sem_post(&(me->sem_prioridad_maxima));
            sem_post(&(me->sem_prioridad_max_otro_nodo));
            sem_wait(&(me->sem_contador_procesos_max_SC));
